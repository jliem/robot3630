...
#if NET_CF20
[assembly: ServiceDeclaration(DssServiceDeclaration.Transform, SourceAssemblyKey = @"cf.motioncontroller.y2008.m02, version=0.0.0.0, culture=neutral, publickeytoken=d159440a8502d2da")]
#else
[assembly: ServiceDeclaration(DssServiceDeclaration.Transform, SourceAssemblyKey = @"motioncontroller.y2008.m02, version=0.0.0.0, culture=neutral, publickeytoken=d159440a8502d2da")]
#endif
#if !URT_MINCLR
