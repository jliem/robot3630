...
using pxsamplesimulation = Robotics.SampleSimulation.Proxy;
using reflection = System.Reflection;


namespace Robotics.SampleSimulation.Proxy
{
    
    
    /// <summary>
    /// SampleSimulation Contract
    /// </summary>
    [XmlTypeAttribute(IncludeInSchema=false)]
    public sealed class Contract
    {
        
        /// The Unique Contract Identifier for the SampleSimulation service
    ...
    /// </summary>
    [DataContract()]
    [XmlRootAttribute("SampleSimulationState", Namespace="http://schemas.tempuri.org/2008/01/samplesimulation.html")]
    public class SampleSimulationState : ICloneable, IDssSerializable
    {
        
        /// <summary>
        /// Copy To Sample Simulation State
        /// </summary>
        public virtual void CopyTo(IDssSerializable target)
        {
            SampleSimulationState typedTarget = target as SampleSimulationState;
    ...
    /// </summary>
    [DataContract()]
    [XmlRootAttribute("TableEntity", Namespace="http://schemas.tempuri.org/2008/01/samplesimulation.html")]
    ...
    /// <summary>
    /// Sample Simulation Operations
    /// </summary>
    [ServicePort()]
    [XmlTypeAttribute(IncludeInSchema=false)]
    public class SampleSimulationOperations : PortSet<Microsoft.Dss.ServiceModel.Dssp.DsspDefaultLookup, Microsoft.Dss.ServiceModel.Dssp.DsspDefaultDrop, Get>
    {
        ...
        /// </summary>
        public virtual PortSet<SampleSimulationState,Fault> Get()
        {
        ...
        /// </summary>
        public virtual PortSet<SampleSimulationState,Fault> Get(Microsoft.Dss.ServiceModel.Dssp.GetRequestType body)
        {
            Get op = new Get();
    ...
    /// </summary>
    [XmlTypeAttribute(IncludeInSchema=false)]
    public class Get : Microsoft.Dss.ServiceModel.Dssp.Get<Microsoft.Dss.ServiceModel.Dssp.GetRequestType, PortSet<SampleSimulationState, Fault>>
    {
        ...
        /// Get
        /// </summary>
        public Get(Microsoft.Dss.ServiceModel.Dssp.GetRequestType body, Microsoft.Ccr.Core.PortSet<SampleSimulationState,W3C.Soap.Fault> responsePort) : 
