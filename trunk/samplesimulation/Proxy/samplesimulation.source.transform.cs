...
#if NET_CF20
[assembly: ServiceDeclaration(DssServiceDeclaration.Transform, SourceAssemblyKey = @"cf.samplesimulation.y2008.m01, version=0.0.0.0, culture=neutral, publickeytoken=d185a51f257aaa63")]
#else
[assembly: ServiceDeclaration(DssServiceDeclaration.Transform, SourceAssemblyKey = @"samplesimulation.y2008.m01, version=0.0.0.0, culture=neutral, publickeytoken=d185a51f257aaa63")]
#endif
#if !URT_MINCLR
...
namespace Dss.Transforms.TransformSampleSimulation
{

    public class Transforms: TransformBase
    {

        public static object Transform_Robotics_SampleSimulation_Proxy_SampleSimulationState_TO_Robotics_SampleSimulation_SampleSimulationState(object transformFrom)
        {
            Robotics.SampleSimulation.SampleSimulationState target = new Robotics.SampleSimulation.SampleSimulationState();
            return target;
        }


        private static Robotics.SampleSimulation.Proxy.SampleSimulationState _instance_Robotics_SampleSimulation_Proxy_SampleSimulationState = new Robotics.SampleSimulation.Proxy.SampleSimulationState();
        public static object Transform_Robotics_SampleSimulation_SampleSimulationState_TO_Robotics_SampleSimulation_Proxy_SampleSimulationState(object ignore)
        {
            return _instance_Robotics_SampleSimulation_Proxy_SampleSimulationState;
        }


        public static object Transform_Robotics_SampleSimulation_Proxy_TableEntity_TO_Robotics_SampleSimulation_TableEntity(object transformFrom)
        {
            Robotics.SampleSimulation.TableEntity target = new Robotics.SampleSimulation.TableEntity();
            Robotics.SampleSimulation.Proxy.TableEntity from = transformFrom as Robotics.SampleSimulation.Proxy.TableEntity;
        ...
        public static object Transform_Robotics_SampleSimulation_TableEntity_TO_Robotics_SampleSimulation_Proxy_TableEntity(object transformFrom)
        {
            Robotics.SampleSimulation.Proxy.TableEntity target = new Robotics.SampleSimulation.Proxy.TableEntity();
            Robotics.SampleSimulation.TableEntity from = transformFrom as Robotics.SampleSimulation.TableEntity;
        ...
        {
            AddProxyTransform(typeof(Robotics.SampleSimulation.Proxy.SampleSimulationState), Transform_Robotics_SampleSimulation_Proxy_SampleSimulationState_TO_Robotics_SampleSimulation_SampleSimulationState);
            AddSourceTransform(typeof(Robotics.SampleSimulation.SampleSimulationState), Transform_Robotics_SampleSimulation_SampleSimulationState_TO_Robotics_SampleSimulation_Proxy_SampleSimulationState);
            AddProxyTransform(typeof(Robotics.SampleSimulation.Proxy.TableEntity), Transform_Robotics_SampleSimulation_Proxy_TableEntity_TO_Robotics_SampleSimulation_TableEntity);
            AddSourceTransform(typeof(Robotics.SampleSimulation.TableEntity), Transform_Robotics_SampleSimulation_TableEntity_TO_Robotics_SampleSimulation_Proxy_TableEntity);
